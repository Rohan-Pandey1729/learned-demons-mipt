...
extensive. Curves of $\I_3(p)$ for different system sizes cross at the
critical point, and the crossings of successive size pairs converge to
$p_c$~\cite{Gullans2020,Zabalo2020}. The drift of these crossings with
system size is the key diagnostic in Sec.~\ref{sec:geometry}.
